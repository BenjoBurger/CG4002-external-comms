...
SEND_PORT = 8000
RECV_PORT = 8010
user_action = ["none", "gun", "reload", "bomb", "badminton", "boxing", "fencing", "golf"]

def relay_client_process(server_ip="localhost", port_number=8000, queue=None, check_client=None):
...
if __name__ == "__main__":
    try:
        player_id = int(input("Player 1 or Player 2? (1/2): "))

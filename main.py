...
def main():
    ...
    try:
        ...
        # Create threads
        from_relay_client_thread = Process(target=relay_server_process, args=(RECV_PORT, relay_to_ai_queue, eval_to_relay_queue, p1_shot_queue, p2_shot_queue, is_relay_client_1_connected, num_players))
        to_relay_client_thread = Process(target=relay_server_process, args=(SEND_PORT, relay_to_ai_queue, eval_to_relay_queue, None, None, is_relay_client_2_connected, num_players))
